...
# Repo: https://github.com/Hermandev07/ProxmoxVED
#
# Usage: bash -c "$(wget -qLO - https://github.com/Hermandev07/ProxmoxVED/raw/main/misc/hw-acceleration.sh)"
#
# Requires:
#   - Proxmox VE 8.1+
...
# https://github.com/Hermandev07/ProxmoxVED
...
source <(wget -qO- https://github.com/Hermandev07/ProxmoxVED/raw/main/tools/pve/gpu-nvidia.func)
source <(wget -qO- https://github.com/Hermandev07/ProxmoxVED/raw/main/tools/pve/gpu-intel.func)
source <(wget -qO- https://github.com/Hermandev07/ProxmoxVED/raw/main/tools/pve/gpu-amd.func)
