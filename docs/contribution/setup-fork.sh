...
# upstream   https://github.com/Hermandev07/ProxmoxVED.git (fetch)
# upstream   https://github.com/Hermandev07/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/Hermandev07/ProxmoxVED"
echo ""
